...
<cheapy:layout pageName="Acceso Denegado">
	<h2 class="text-center" style="font-family: 'Lobster'; font-size: 30px; color: rgb(0, 64, 128); padding:30px"><em>No dispone de las credenciales necesarias para poder acceder a esta página.</em></h2>
